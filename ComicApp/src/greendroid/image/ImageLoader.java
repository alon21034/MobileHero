    ...
    private class ImageFetcher implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    int thumbnailId = Integer.parseInt(mUrl);
                    bitmap = MediaStore.Images.Thumbnails.getThumbnail(mContext.getApplicationContext()
                            .getContentResolver(), thumbnailId, MediaStore.Images.Thumbnails.MICRO_KIND, null);
                } catch (NumberFormatException e) {
                    // So mUrl is not an ID, it must be an URL, handled below
                }
                ...
                if (bitmap == null) {
                    ...
                    bitmap = BitmapFactory.decodeStream(inputStream, null, (mOptions == null) ? sDefaultOptions
                            : mOptions);
                }
