...
public class Panel extends LinearLayout
{
	...
	{
		Log.i("panel","panel onAttachedToWindow");
	...
	{
		Log.i("panel","panel dispatchDraw");
	...
	OnTouchListener touchListener = new OnTouchListener()
	{
		...
		public boolean onTouch(View v, MotionEvent event)
		{
			...
			Log.i("panel","panel onTouch");
			if (mAnimating)
			{
				// we are animating
				return true;// �函銝凋���onTouch鈭辣
			}
	...
	class PanelOnGestureListener implements OnGestureListener
	{
				...
				float velocityY)
		{
			...
			if (lastRawX == -1 && lastRawY == -1)	//閫nScroll�寞�
			{
